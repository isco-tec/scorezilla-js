...
- [#54](https://github.com/isco-tec/scorezilla-js/pull/54) [`daf2cce`](https://github.com/isco-tec/scorezilla-js/commit/daf2ccef4e2d64b2bcea563e411f80d08ec63491) Thanks [@isco-tec](https://github.com/isco-tec)! - Fix: score submission now works from plain-http origins (LAN IPs, non-localhost dev hostnames).
